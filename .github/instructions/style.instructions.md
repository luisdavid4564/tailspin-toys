...
- Comment only the design intent behind non-obvious styling; do not annotate utility classes by repeating what they visibly do.
- Keep styling comments current when the design changes.
